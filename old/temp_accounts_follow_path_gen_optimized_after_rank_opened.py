...
current_col_number = 13
new_col_number = current_col_number + 1
print("Preparing column number %d."%(new_col_number))
...
new_accounts_rank_opened_indexes = []
for i in range(len(usernames)):
    if new_accounts_rank_opened[i]: new_accounts_rank_opened_indexes.append(i)
print(len(new_accounts_rank_opened_indexes))
